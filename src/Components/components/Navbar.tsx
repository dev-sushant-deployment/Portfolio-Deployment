...
export const Navbar : React.FC<NavbarProps> = ({}) => {
  ...
  return (
    <div className="text-white flex py-4 justify-between px-8 font-semibold text-xl sm:text-2xl fixed top-0 left-0 w-lvw z-[10001] uppercase bg-[#111111] shadow-2xl shadow-[#111111]">
